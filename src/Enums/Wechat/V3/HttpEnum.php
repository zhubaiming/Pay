...
namespace Zhubaiming\Pay\Enums\Wechat\V3;
...
enum HttpEnum: int
{
    ...
    {
//        return in_array($this, [self::OK, self::ACCEPTED, self::NO_CONTENT], true);
        return match ($code) {
    ...
    // 通过状态码获取枚举实例
//    public static function fromCode(int $code): HttpEnum
//    {
//        die($code);
//        return self::tryFrom($code);  // 使用 tryFrom() 获取枚举实例
//    }
}
